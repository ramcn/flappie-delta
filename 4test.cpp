...
int main(void)
{
    ...
    //float B[5] = { -1, 2, -1, 1 };
    float A[] = {0.115, 0.061, 0.110, 0.054, -0.004, 0.148, 0.032, -0.112, 
	         0.176, 0.047, -0.080, 0.028, -0.036, 0.138, 0.067, 0.162};

    float B[] = {0.062, -0.207,-0.762, 0.303};
    float BNEXT[] = {-0.233, -0.245, -0.975, -0.517};
    float BNEXT1[] = { 0.396, -0.020, -0.933, -0.401};
